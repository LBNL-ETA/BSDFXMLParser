...
TEST(THMZFile, DeserializationDifferentAttributeCaps)
{
    SCOPED_TRACE("Begin Test: THMZ-Geometry-DifferentCapsAttributes.XML");
    std::filesystem::path product_path(TEST_DATA_DIR);
    product_path /= "products";
    product_path /= "THMZ-Geometry-DifferentCapsAttributes.XML";
